export default class Player extends Phaser.Physics.Arcade.Sprite {
    constructor(data) {
        ...
        let dodoState = "defaultLeft";                          // 도도가 왼쪽을 보는지 오른쪽을 보는지
        let key;
    ...
    static preload(scene) {
        // 캐릭터
        scene.load.spritesheet("dodo", "./images/Leaf/img_character_dodo.png", { frameWidth: 188, frameHeight: 216 });
    }
    ...
    create() {
        ...
        this.setOffset(0, 100);                                          // 충돌체 위치 조정
        ...
        this.anims.create({
            key: "defaultRight",
            frames: this.anims.generateFrameNumbers("dodo", { frames: [2, 3] }),
            frameRate: 2,
            repeat: -1
        });
        ...
        this.anims.create({
            key: "right",
            frames: this.anims.generateFrameNumbers("dodo", { frames: [6, 7] }),
            frameRate: 6,
            repeat: -1
        })
        // ] 애니메이션 end

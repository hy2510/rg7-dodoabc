export default class Mole extends Phaser.GameObjects.Container {
    constructor(data) {
        ...
        this.bg.on('animationstart', frame => {
            ...
            if (animation == "default") {
                ...
                this.scene.gino.changeFrame(animation);
        ...
        this.bg.on('animationcomplete', frame => {
            ...
            if (animation == "correct") {
                ...
                this.scene.gino.changeFrame("default");
    ...
    static preload(scene) {
        scene.load.spritesheet("moleDefault", "./images/Mole2/img_mole_default.png", { frameWidth: 370, frameHeight: 249 })
        scene.load.spritesheet("moleCorrect", "./images/Mole2/img_mole_correct.png", { frameWidth: 370, frameHeight: 249 })
        scene.load.spritesheet("moleIncorrect", "./images/Mole2/img_mole_incorrect.png", { frameWidth: 370, frameHeight: 249 })
    }
